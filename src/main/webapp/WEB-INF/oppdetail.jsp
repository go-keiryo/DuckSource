...
<nav class="art-nav">
    <ul class="art-hmenu"><li><a href="main?creatorId=${userId}">Home Page</a></li><li><a href="findopp?creatorId=${userId}" class="">Find an Opportunity</a></li><li><a href="createopp?creatorId=${userId}" class="">Create an Opportunity</a></li><li><a href="account-settings.html">Account Settings</a></li><li><a href="index">Sign Out</a></li></ul> 
    </nav>
